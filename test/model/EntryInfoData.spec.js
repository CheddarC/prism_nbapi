...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PrismNbapi.EntryInfoData();
  });
  ...
  describe('EntryInfoData', function() {
    it('should create an instance of EntryInfoData', function() {
      // uncomment below and update the code to test EntryInfoData
      //var instane = new PrismNbapi.EntryInfoData();
      //expect(instance).to.be.a(PrismNbapi.EntryInfoData);
    });
    ...
    it('should have the property meterBands (base name: "meter_bands")', function() {
      // uncomment below and update the code to test the property meterBands
      //var instane = new PrismNbapi.EntryInfoData();
      //expect(instance).to.be();
    });
