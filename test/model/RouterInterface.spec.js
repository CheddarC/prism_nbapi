...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PrismNbapi.RouterInterface();
  });
  ...
  describe('RouterInterface', function() {
    it('should create an instance of RouterInterface', function() {
      // uncomment below and update the code to test RouterInterface
      //var instane = new PrismNbapi.RouterInterface();
      //expect(instance).to.be.a(PrismNbapi.RouterInterface);
    });
