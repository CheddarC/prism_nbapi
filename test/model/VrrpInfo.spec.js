...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PrismNbapi.VrrpInfo();
  });
  ...
  describe('VrrpInfo', function() {
    it('should create an instance of VrrpInfo', function() {
      // uncomment below and update the code to test VrrpInfo
      //var instane = new PrismNbapi.VrrpInfo();
      //expect(instance).to.be.a(PrismNbapi.VrrpInfo);
    });
