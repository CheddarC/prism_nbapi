...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PrismNbapi.DhcpInfoHosts();
  });
  ...
  describe('DhcpInfoHosts', function() {
    it('should create an instance of DhcpInfoHosts', function() {
      // uncomment below and update the code to test DhcpInfoHosts
      //var instane = new PrismNbapi.DhcpInfoHosts();
      //expect(instance).to.be.a(PrismNbapi.DhcpInfoHosts);
    });
