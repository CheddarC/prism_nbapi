...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PrismNbapi.DhcpSvrInfoHosts();
  });
  ...
  describe('DhcpSvrInfoHosts', function() {
    it('should create an instance of DhcpSvrInfoHosts', function() {
      // uncomment below and update the code to test DhcpSvrInfoHosts
      //var instane = new PrismNbapi.DhcpSvrInfoHosts();
      //expect(instance).to.be.a(PrismNbapi.DhcpSvrInfoHosts);
    });
