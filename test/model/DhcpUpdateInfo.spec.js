...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PrismNbapi.DhcpUpdateInfo();
  });
  ...
  describe('DhcpUpdateInfo', function() {
    it('should create an instance of DhcpUpdateInfo', function() {
      // uncomment below and update the code to test DhcpUpdateInfo
      //var instane = new PrismNbapi.DhcpUpdateInfo();
      //expect(instance).to.be.a(PrismNbapi.DhcpUpdateInfo);
    });
