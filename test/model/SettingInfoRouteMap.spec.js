...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PrismNbapi.SettingInfoRouteMap();
  });
  ...
  describe('SettingInfoRouteMap', function() {
    it('should create an instance of SettingInfoRouteMap', function() {
      // uncomment below and update the code to test SettingInfoRouteMap
      //var instane = new PrismNbapi.SettingInfoRouteMap();
      //expect(instance).to.be.a(PrismNbapi.SettingInfoRouteMap);
    });
